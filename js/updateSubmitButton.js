...
function updateSubmitButton() {
    ...
    submitButton.style.backgroundColor = (isValidData && isFormOpen) ? '' : 'gray';
    submitButton.disabled = (isValidData && isFormOpen) ? false : true;
    submitButton.style.cursor = (isValidData && isFormOpen) ? 'pointer' : 'not-allowed';
